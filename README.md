...
Astro, Tailwind CSS, TypeScript, Bun, Cloudflare Pages, GoatCounter for analytics.
...
Optional env: `PUBLIC_SPOTIFY_EMBED_URL` (Spotify embed is commented out for now)
