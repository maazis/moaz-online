...
<Layout>
  <main class="h-screen flex flex-col items-center justify-center p-4 md:p-8">
    <div class="max-w-2xl markdown-content">
      ...
      I worked on this website <a href="https://github.com/maazis/moaz-online" target="_blank" rel="noopener noreferrer">[<i class="ph-bold ph-github-logo inline-block"></i>]</a> using Astro, Bun, Tailwind CSS.
